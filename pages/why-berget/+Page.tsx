...
function Page() {
  ...
  return (
    <>
      <SEOHelmet
        title="Varför Berget - Berget AI | Säker och Hållbar AI för Europa"
        description="Upptäck varför Berget AI är det bästa valet för företag som kräver säkerhet, efterlevnad och hållbarhet i sina AI-lösningar."
        language="sv"
        type="website"
        path="/why-berget"
        keywords={['Varför Berget', 'Säker AI', 'GDPR', 'NIS2', 'Hållbar AI', 'Europeisk AI', 'Data Privacy']}
