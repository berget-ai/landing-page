...
export default function Page() {
  ...
  return (
    <>
      <SEOHelmet
        title="Produkter - Berget AI | AI-infrastruktur och Tjänster"
        description="Utforska Berget AIs produkter: serverless inference, dedikerad infrastruktur och vår fullständiga AI-plattform för företag."
        language="sv"
        type="website"
        path="/products"
        keywords={['Produkter', 'Serverless AI', 'Dedikerad AI', 'AI-plattform', 'LLM', 'GPU', 'Inference']}
