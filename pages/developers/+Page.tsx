...
export default function Page() {
  ...
  return (
    <>
      <SEOHelmet
        title="Utvecklare - Berget AI | API och Dokumentation"
        description="Kom igång med Berget AIs API för utvecklare. Snabb integration, omfattande dokumentation och fullständig kontroll över dina AI-modeller."
        language="sv"
        type="website"
        path="/developers"
        keywords={['Utvecklare', 'API', 'Dokumentation', 'SDK', 'Integration', 'AI API', 'LLM API']}
