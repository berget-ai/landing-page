...
export default function Page() {
  ...
  return (
    <>
      <SEOHelmet
        title="SaaS - Berget AI | AI-infrastruktur för SaaS-företag"
        description="Bygg och skala din SaaS med Berget AI. GDPR-kompatibel, kostnadseffektiv AI-infrastruktur för europeiska företag."
        language="sv"
        type="website"
        path="/saas"
        keywords={['SaaS', 'AI för SaaS', 'GDPR', 'Skalbar AI', 'Europeisk infrastruktur', 'Data Privacy']}
