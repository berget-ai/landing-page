...
export default function Page() {
  ...
  return (
    <>
      <SEOHelmet
        title="Om Oss - Berget AI | Vår Vision och Värderingar"
        description="Lär känna Berget AI - vårt team, våra värderingar och vår vision för en säker och hållbar AI-plattform för Europa."
        language="sv"
        type="website"
        path="/about"
        keywords={['Om Berget', 'Team', 'Vision', 'Värderingar', 'Open Source', 'Europeisk AI']}
