...
export default function Page() {
  return (
    <>
      <SEOHelmet
        title="Open Source - Berget AI | Open Source Program"
        description="Berget AI stöder open source-communityt med gratis resurser och infrastruktur. Läs mer om vårt Open Source Program och ansök idag."
        language="sv"
        type="website"
        path="/open-source"
        keywords={['Open Source', 'Program', 'Gratis AI', 'AI för open source', 'Community', 'Bidrag']}
