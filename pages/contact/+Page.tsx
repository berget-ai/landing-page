...
export default function Page() {
  ...
  return (
    <>
      <SEOHelmet
        title="Kontakt - Berget AI | Kom i kontakt med oss"
        description="Kontakta Berget AI för frågor om våra AI-tjänster, demo, eller samarbeten. Vi finns här för att hjälpa dig komma igång med AI."
        language="sv"
        type="website"
        path="/contact"
        keywords={['Kontakt', 'Berget AI', 'Demo', 'Support', 'Kontakta oss', 'AI-tjänster']}
