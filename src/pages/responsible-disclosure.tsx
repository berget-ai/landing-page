        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <p>
                If you have found a vulnerability in one of our public GitHub
                repositories, you can report it privately using GitHub's
              ...
              <div className="bg-white/5 rounded-xl p-6 my-8 border border-white/10">
                ...
                <ol className="list-decimal list-inside space-y-2 text-white/80">
                  <li>
                    Navigate to the main page of the affected repository on
                    GitHub
                  </li>
                  <li>
                  ...
                  <li>
                    Click <strong>"Report a vulnerability"</strong> to open the
                    advisory form
                  </li>
                  <li>
                ...
                <p className="mt-4 text-sm text-white/60">
                  This process is completely private and GitHub will notify our
                  security team directly. You'll automatically be added as a
              ...
              <p>
                For vulnerabilities that cannot be reported through GitHub, or
