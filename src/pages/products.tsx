          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-3 gap-6">
              <motion.div
                ...
                viewport={{ once: true }}
                className="p-6 rounded-xl bg-card/10 border border-border hover:bg-card/20 transition-colors"
              >
                            ...
                            <div className="relative p-6 rounded-2xl border border-border bg-card/10">
                              ...
                              <div className="grid grid-cols-4 gap-4">
                                {layer.items.map((item: string) => (
                                  <div
                                    key={item}
                                    className="px-4 py-3 rounded-lg bg-muted/50 text-sm text-center border border-border hover:bg-muted transition-colors"
                                  >
                                    {item}
                                  </div>
                                ))}
                    ...
                    <div className={`relative h-full group`}>
                      ...
                      <div className="relative h-full p-6 rounded-2xl border border-border bg-card/10 flex flex-col">
                        <div className="flex items-center gap-4 mb-8">
                          <div className={`w-12 h-12 rounded-xl bg-muted flex items-center justify-center`}>
                            <managementStack.icon className="w-6 h-6" />
                          </div>
                          <div>
                        ...
                        <div className="flex-1 flex flex-col justify-center space-y-4">
                          {(t('products.architecture.layers.management.items', { returnObjects: true }) as string[]).map((item: string) => (
                            <div
                              key={item}
                              className="p-4 rounded-lg bg-muted/50 text-sm text-center border border-border hover:bg-muted transition-colors"
                            >
                              {item}
                            </div>
                          ))}
